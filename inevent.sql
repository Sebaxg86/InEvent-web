...
--
-- Servidor: localhost
-- Tiempo de generación: 16-05-2025 a las 16:56:39
...
ALTER TABLE `order_items`
  ...
  ADD KEY `fk_order_items_event` (`event_id`);
...
--
ALTER TABLE `order_items`
  ADD CONSTRAINT `fk_order_items_event` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`),
  ADD CONSTRAINT `order_items_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`seat_id`) REFERENCES `seats` (`id`) ON DELETE CASCADE;
