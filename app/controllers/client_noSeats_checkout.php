...
try {
    ...
    // ======= 2. Register Tickets in the 'order_items' Table =======
    ...
    // ======= 4. Obtain PayPal Token Using cURL =======
    ...
    // ======= Use APP_URL to Form Absolute URLs =======
    $baseUrl = env('APP_URL'); 
    ...
    // ======= Return Approval URL and Order ID to Front-end =======
    echo json_encode([
